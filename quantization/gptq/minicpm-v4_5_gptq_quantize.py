"""
Quantize MiniCPM-V 4.5's LLM backbone (Qwen3ForCausalLM) to 4-bit using GPTQ.
...
Install AutoGPTQ from source; patch qwen3.py, auto.py, __init__.py, _const.py, _base.py per quantization/gptq/minicpm-v4_5_gptq_quantize.md.
cd MiniCPM-V-CookBook
python quantization/gptq/minicpm-v4_5_gptq_quantize.py
"""
import os
import sys
import json
